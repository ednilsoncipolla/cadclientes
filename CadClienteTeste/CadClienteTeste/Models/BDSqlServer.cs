...
namespace BDSqlServer
{
    public class BD
    {
        public static string sConexao = "Server=tcp:sqlserver,1433;Initial Catalog=iEquipe;Persist Security Info=False;User ID=;Password=153759@edy;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
